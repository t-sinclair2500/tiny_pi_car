...
#采集标定图像，保存在calib文件夹下(Collect calibration images and save them in the 'calib' folder.)
#按下键盘上的space键存储图像，按esc退出(Press the 'space' key on the keyboard to save the image, and press the 'esc' to exit.)
